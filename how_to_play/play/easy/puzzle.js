...
function showCompletionScreen(selectedFolder) {
    ...
    originalImage.style.width = "242px"; // Set size
    originalImage.style.height = "243px"; // Set size
...
function getStarRating(turns) {
    if (turns <= 14) {
        return "⭐⭐⭐⭐⭐";
    } else if (turns > 14 && turns <= 25) {
        return "⭐⭐⭐⭐";
    } else if (turns > 25 && turns <= 30) {
        return "⭐⭐⭐";
    } else if (turns > 30 && turns <= 35) {
        return "⭐⭐";
    } else {
        return "⭐";
    }
...
// Load the selected image folder when the page loads
